...
public class RetrieveOrdersResponseStepTest {

    DatabaseHelper databaseHelper;
    DTOHelper dtoHelper;
    RedisHelper redisHelper;
    RetrieveOrdersResponseStep retrieveOrdersResponseStep;
    ...
    public void setUp() throws Exception {
        ...
        retrieveOrdersResponseStep = new RetrieveOrdersResponseStep(databaseHelper, dtoHelper, redisHelper);
    }
