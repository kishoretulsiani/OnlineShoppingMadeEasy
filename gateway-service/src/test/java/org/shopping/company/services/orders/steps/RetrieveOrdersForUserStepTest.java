...
public class RetrieveOrdersForUserStepTest {

    DatabaseHelper databaseHelper;
    DTOHelper dtoHelper;
    RedisHelper redisHelper;
    RetrieveOrdersForUserStep retrieveOrdersForUserStep;
    ...
    public void setUp() throws Exception {
        ...
        retrieveOrdersForUserStep = new RetrieveOrdersForUserStep(databaseHelper, dtoHelper, redisHelper);
    }
    ...
    @Test
    //TODO
    public void filter_ordeIds_based_on_input_request_test() {
    ...
    @Test
    //TODO
    public void return_all_orders_test() {
        Assert.assertTrue(true);
    }
